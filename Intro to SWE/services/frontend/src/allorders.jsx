...
function AllOrders({ apiUrl = 'http://localhost:3000' }) {
  ...
  const filteredOrders = orders.filter(order => {
    ...
    const userName = order.user_name || order.user_id;
    const matchesUser = !searchUser || userName.toLowerCase().includes(searchUser.toLowerCase());
            ...
            <div key={order.id} className="order-card">
              <div className="order-header" onClick={() => toggleOrder(order.id)}>
                <div className="order-header-left">
                  ...
                  <span className="order-user-name">👤 User: {order.user_name || 'Unknown'}</span>
                </div>
                  ...
                  <div className="order-details-grid">
                    <div className="order-detail-section">
                      ...
                      <div className="order-info-row">
                        ...
                        <span className="value">{order.user_name || 'Unknown'}</span>
                      </div>
                      <div className="order-info-row">
                        <span className="label">User ID:</span>
                        <span className="value" style={{fontSize: '0.8rem', fontFamily: 'monospace'}}>{order.user_id.substring(0, 20)}...</span>
                      </div>
                      <div className="order-info-row">
