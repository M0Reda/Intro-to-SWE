...
function App() {
  ...
  const handleCODPayment = async () => {
    ...
    try {
      ...
      // Create the order with COD - stays in PENDING status
      const res = await fetch(`${API_URLS.orders}/orders`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
      ...
      showMessage('Order placed successfully! Payment will be collected on delivery. Order status: PENDING', 'success');
      setShowPayment(false);
      setCurrentOrder(null);
      await clearCart();
