...
function Payment({ orderId, amount, onSuccess, onCancel, apiUrl = 'http://localhost:3002' }) {
  ...
  }, [paypalClientId, orderId, amount, apiUrl, getToken, onSuccess, onCancel, useSimulation]);
